      ...
      <div className="flex justify-between">
        ...
        <div className="flex items-center">
          <Typography variant="h6" color="black" className="ml-2">
            ...
            <Typography variant="small" color="blue-gray" className="ml-2">{employee_role}</Typography>
        </div>
      </div>
        <div className="flex items-center">
          ...
          {/* <Link to="/auth/sign-in"> */}
            <Button variant="text" color="blue-gray" className="hidden items-center gap-1 px-4 xl:flex" onClick={handleSignOut} >
