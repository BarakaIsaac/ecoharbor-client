...
function AssetCreateModal({ showCreateModal, setShowCreateModal, handleCreateAsset, departmentNames, newAsset, setNewAsset, showCustomCategoryInput, uniqueAssetCategories }) {
  return (
    <div>
        <Modal
