...
function AssetAllocationModal({showEditAllocationModal, setShowEditAllocationModal, selectedAsset, editedAsset, setEditedAsset, handleSaveEditAllocation, departmentNames, employeeNames} ) {
  return (
        <Modal
            ...
            contentLabel="Asset Allocation Modal"
            ...
            <div className="bg-white w-1/3 p-6 rounded-lg">
                ...
                <div>
                    ...
                    <div className="block w-full mt-1 p-2 border rounded-md bg-gray-100 focus:outline-none focus:ring focus:border-blue-300">{editedAsset.asset_category}</div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select value={editedAsset.employee_id} 
                        onChange={e => setEditedAsset({ ...editedAsset, employee_id: e.target.value })}
                        className="block w-full mt-1 p-2 border rounded-md bg-gray-100 focus:outline-none focus:ring focus:border-blue-300" >
                        <option value="" disabled className="text-grey-100" style={{ opacity: 0.6 }}>Select an Employee</option>
                        <option value="" key="blank"></option>
