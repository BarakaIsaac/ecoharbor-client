...
function MyAssetNewRequestModal({ showNewAssetRequestModal, setShowNewAssetRequestModal, handleNewAssetRequest, departmentNames, newAsset, setNewAssetRequetst, }) {
    return (
        <Modal
...
export default MyAssetNewRequestModal
